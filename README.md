...
Software engineering principles, from Mariano Anaya -  book
[*Clean Code in Python: Develop maintainable and efficient code *](https://www.amazon.com/Clean-Code-Python-maintainable-efficient/dp/1800560214/ref=pd_lpo_14_t_0/134-9593271-8844546?_encoding=UTF8&pd_rd_i=1800560214&pd_rd_r=49966a97-0ffe-4598-9ecb-ff7cc82b27a9&pd_rd_w=0pp6e&pd_rd_wg=wcUf7&pf_rd_p=a0d6e967-6561-454c-84f8-2ce2c92b79a6&pf_rd_r=GQ99PVGBX7P98GKRS7X7&psc=1&refRID=GQ99PVGBX7P98GKRS7X7),
...
print(name, surname)  # => Cavid Rzayev
```
...
person = Person("Cavid Rzayev")
print(person.name)  # => "Cavid Rzayev"
print(person.name_as_first_and_last)  # => ["Cavid", "Rzayev"]
```
